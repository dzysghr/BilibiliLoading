package com.dzy.bilibililoading.ptr;
...
/**
 * 下拉刷新布局 参考 https://github.com/dzysghr
...
public class PullToRefreshLayout extends FrameLayout implements ValueAnimator.AnimatorUpdateListener
{
    ...
    private boolean checkHorizental(MotionEvent ev)
    {
        ...
        {
            Log.e("tag", "mHorizontalScolling = true");
    ...
    /**
     * 通知Header状态改变
     * @param state 状态枚举 {@link com.dzy.bilibililoading.ptr.HeaderState}
     */
